...
function updatePassportText(lang) {
    const passportTexts = {
        'ru': {
            'text-mvd': 'ГУ МВД РОССИИ ПО Г. МОСКВЕ',
            'text-surname': 'ДОВГАЛЕВА',
            'text-name': 'КСЕНИЯ',
            'text-patronymic': 'МИХАЙЛОВНА',
            'text-birthplace': 'ГОР. МОСКВА'
        },
        'en': {
            'text-mvd': 'GU OF MVD OF RUSSIA IN MOSCOW',
            'text-surname': 'DOVGALEVA',
            'text-name': 'KSENIIA',
            'text-patronymic': 'MIKHAILOVNA',
            'text-birthplace': 'MOSCOW CITY'
        }
    };
